...
export function Meter({ cents, state }: Props) {
  ...
  return (
    <div className="w-full max-w-md">
      <svg viewBox="0 0 200 116" className="w-full" role="img" aria-label="Viritysmittari">
        <path
        ...
        />
        <path
          d="M 84 22.5 A 84 84 0 0 1 116 22.5"
          fill="none"
        ...
        />
        <text x="22" y="114" fontSize="11" fill="var(--tuner-label)">
          matala
        </text>
        <text x="150" y="114" fontSize="11" fill="var(--tuner-label)">
          korkea
        </text>
        <g
          style={{
        ...
        <circle cx="100" cy="104" r="11" fill={color} opacity={cents === null ? 0.35 : 1} />
      </svg>
    </div>
  );
}
