...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Helppo ukulelen viritysmittari lapsille selaimessa.",
      },
      { name: "author", content: "Opit soittamaan!" },
      { property: "og:title", content: "Ukuleleviritin – Opit soittamaan!" },
      { property: "og:description", content: "Viritetään ukulele helposti!" },
